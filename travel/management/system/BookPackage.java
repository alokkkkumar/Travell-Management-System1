...
public class BookPackage extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == checkprice){
            ...
            try{
                Conn c = new Conn();
                c.s.execute("insert into bookpackage values('"+labelusername.getText()+"', '"+cpackage.getSelectedItem()+"', '"+tfpersons.getText()+"','"+labelid.getText()+"', '"+labelnumber.getText()+"', '"+labelphonenumber.getText()+"', '"+labelprice.getText()+"')");
                
                JOptionPane.showMessageDialog(null, "Pckage Booked Successfully");
                setVisible(false);
            }catch(Exception e){
                e.printStackTrace();
            }
